...
set_target_properties(GeographicLib::GeographicLib_SHARED PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libGeographicLib.so.26.1.0"
  IMPORTED_SONAME_RELEASE "libGeographicLib.so.26"
  )

list(APPEND _IMPORT_CHECK_TARGETS GeographicLib::GeographicLib_SHARED )
list(APPEND _IMPORT_CHECK_FILES_FOR_GeographicLib::GeographicLib_SHARED "${_IMPORT_PREFIX}/lib/libGeographicLib.so.26.1.0" )
